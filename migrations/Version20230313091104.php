 ...
 */
final class Version20230313091104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company_sheet (id INT AUTO_INCREMENT NOT NULL, association_id INT DEFAULT NULL, agreement_id INT DEFAULT NULL, company_name VARCHAR(255) NOT NULL, loan_status VARCHAR(255) NOT NULL, date_of_ce DATE NOT NULL, repayment_start_date DATE NOT NULL, repayment_end_date DATE DEFAULT NULL, fni_amount_requested INT NOT NULL, fni_amount_paid INT NOT NULL, payment_one INT NOT NULL, payment_two INT DEFAULT NULL, payment_one_date DATE NOT NULL, payment_two_date DATE DEFAULT NULL, remains_to_be_paid INT NOT NULL, remains_to_be_received INT NOT NULL, total_amount_repaid_to_date INT NOT NULL, total_fni_amount_requested INT NOT NULL, total_fni_amount_paid INT NOT NULL, project_leader_name1 VARCHAR(255) NOT NULL, project_leader_name2 VARCHAR(255) DEFAULT NULL, project_leader_name3 VARCHAR(255) DEFAULT NULL, project_leader_name4 VARCHAR(255) DEFAULT NULL, INDEX IDX_C0CD3387EFB9C8A5 (association_id), INDEX IDX_C0CD338724890B2B (agreement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_leader (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
