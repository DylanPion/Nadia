 ...
 */
final class Version20230209091301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company_sheet (id INT AUTO_INCREMENT NOT NULL, association_id INT DEFAULT NULL, company_name VARCHAR(255) NOT NULL, INDEX IDX_C0CD3387EFB9C8A5 (association_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
