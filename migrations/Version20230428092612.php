 ...
 */
final class Version20230428092612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT AUTO_INCREMENT NOT NULL, damage_history INT DEFAULT NULL, account2748 INT DEFAULT NULL, account4671 INT DEFAULT NULL, year DATE DEFAULT NULL, total_amount_fni_paid INT DEFAULT NULL, total_amount_repaid_to_date INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE weather (id INT AUTO_INCREMENT NOT NULL, company_sheet_id INT DEFAULT NULL, weather_year DATE DEFAULT NULL, unpaid_number INT DEFAULT NULL, assessment_scale INT DEFAULT NULL, retainer_percentage INT DEFAULT NULL, liquidation_date DATE DEFAULT NULL, bpi_guarantee VARCHAR(255) DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, amount_of_damage INT DEFAULT NULL, loan_status VARCHAR(255) NOT NULL, date_of_the_last_day_of_the_year DATE DEFAULT NULL, amount_of_accounting_provision INT DEFAULT NULL, INDEX IDX_4CD0D36E938513C8 (company_sheet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE weather_table (id INT AUTO_INCREMENT NOT NULL, retainer_percentage INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE weather_table');
